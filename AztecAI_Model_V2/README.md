...
│   ├── AztecAI_Complete_Knowledge_Base.md # ← Importar en OpenWebUI (Principal)
│   ├── TV_Azteca_Informacion_Corporativa.md # ← Importar en OpenWebUI (Corporativo)
│   ├── Funcionamiento TV Aztec.md         # ← Importar en OpenWebUI (Operativo)
...
5. **Knowledge Base No Está en el Modelo**
   ...
   - Debes importar los **3 archivos** de Knowledge Base
