...
print_final_info() {
    ...
    echo "  3. Importa Knowledge Base (3 archivos):"
    echo "     • Workspace → Documents"
    echo "     • Subir los 3 archivos:"
    ...
    echo "     • Top-K: 5"
    echo "  5. Verifica embeddings:"
    echo "     • Workspace → Documents"
    echo "     • Los 3 archivos deben mostrar 'Embedded'"
    echo "  6. Prueba el modelo con:"
