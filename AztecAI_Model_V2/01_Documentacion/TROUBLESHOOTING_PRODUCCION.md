...
### Diagnóstico
```
1. ¿Los 3 archivos de Knowledge Base importados en OpenWebUI?
   → Workspace → Documents → Verificar que existan:
...
3. ¿Collection creada con los 3 documentos?
   → Settings → RAG → Collections → "AztecAI"
   → Verificar que los 3 documentos estén en la Collection

4. ¿Embeddings generados?
   → Workspace → Documents → Verificar estado "Embedded"
