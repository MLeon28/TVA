...
- [ ] Archivo `TV_Azteca_Informacion_Corporativa.md` importado en OpenWebUI
- [ ] Archivo `Funcionamiento TV Aztec.md` importado en OpenWebUI
- [ ] Sin errores durante importación
- [ ] Los 3 documentos visibles en Workspace → Documents
...
**Tamaños de archivos:**
- AztecAI_Complete_Knowledge_Base.md: ~68 KB (1,652 líneas)
- TV_Azteca_Informacion_Corporativa.md: ~22 KB (465 líneas)
- Funcionamiento TV Aztec.md: ~7 KB (73 líneas)

---

### Configuración RAG
- [ ] Collection "AztecAI" creada
- [ ] Los 3 archivos de Knowledge Base agregados a la Collection
- [ ] Top-K configurado a 5
- [ ] RAG activado en Settings
- [ ] Embeddings generados correctamente para los 3 documentos

**Ruta en OpenWebUI:**
```
Settings → RAG → Collections → Create "AztecAI"
Settings → RAG → Top-K: 5
Workspace → Documents → Seleccionar los 3 archivos → Add to Collection "AztecAI"
```
