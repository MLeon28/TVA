...
### 6.2 Subir Knowledge Base (3 archivos)

**IMPORTANTE:** Debes importar los **3 archivos** de Knowledge Base:

Ubicación de los archivos:
```
/opt/AztecAI_Model/03_Knowledge_Base/AztecAI_Complete_Knowledge_Base.md
/opt/AztecAI_Model/03_Knowledge_Base/TV_Azteca_Informacion_Corporativa.md
/opt/AztecAI_Model/03_Knowledge_Base/Funcionamiento TV Aztec.md
```

**Descripción de cada archivo:**
1. **AztecAI_Complete_Knowledge_Base.md** (~68 KB)
   - System prompt completo con identidad, guardrails y framework operativo
   - Base principal del comportamiento del asistente

2. **TV_Azteca_Informacion_Corporativa.md** (~22 KB)
   - Información corporativa detallada de TV Azteca
   - Estructura organizacional, áreas funcionales, procesos

3. **Funcionamiento TV Aztec.md** (~7 KB)
   - Guía operativa de TV Azteca
   - Canales, áreas, clientes y flujos de trabajo

Subir los **3 archivos** en OpenWebUI (puedes seleccionarlos todos a la vez)

### 6.3 Verificar Importación

- Los 3 documentos aparecen en lista
- Sin errores durante la importación
- Cada archivo muestra su tamaño correcto
...
### 7.3 Agregar Documentos a la Collection

1. Ir a **Workspace** → **Documents**
2. Seleccionar los **3 archivos** de Knowledge Base
3. Click en **Add to Collection**
4. Seleccionar Collection: **AztecAI**
5. **Confirm**

### 7.4 Configurar Parámetros
...
### 7.6 Verificar Embeddings

- Los 3 documentos deben mostrar estado "Embedded"
- Tiempo de procesamiento: 2-5 minutos
- Si hay errores, reintentar la generación de embeddings
...
**Solución:**
1. Verificar que los 3 archivos de Knowledge Base estén importados
2. Verificar que los 3 archivos estén en la Collection "AztecAI"
3. Recrear Collection "AztecAI" si es necesario
4. Regenerar embeddings para los 3 documentos
5. Iniciar conversación NUEVA
6. Top-K mínimo: 5
...
- [ ] OpenWebUI corriendo
- [ ] Knowledge Base importada (3 archivos)
- [ ] RAG configurado (Collection: AztecAI con 3 documentos)
- [ ] Embeddings generados para los 3 documentos
